  ...
  _createClass(Colors, [{
    ...
    value: function render() {
      ...
      var circles = colors.map(function (color) {
        _react2.default.createElement('span', { key: color.color, className: 'circle', style: { background: color.code }, onClick: _this2.handleClick.bind(_this2, color.code) });
      });
...
//# sourceMappingURL=0.99f6be9d6e80b1061c4e.hot-update.js.map