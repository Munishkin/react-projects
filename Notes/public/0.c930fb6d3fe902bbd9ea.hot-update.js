  ...
  _createClass(Colors, [{
    ...
    value: function render() {
      var circles = colors.map(function (color) {
        return _react2.default.createElement('span', { key: color.color, className: 'circle', style: { color: color.code } });
      });
...
//# sourceMappingURL=0.c930fb6d3fe902bbd9ea.hot-update.js.map