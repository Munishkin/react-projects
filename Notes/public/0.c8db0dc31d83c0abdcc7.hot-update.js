  ...
  _createClass(Colors, [{
    ...
    value: function render() {
      var circles = colors.map(function (color) {
        return _react2.default.createElement('span', { key: color.color, className: 'circle', style: { backgroundColor: color.code } });
      });
...
//# sourceMappingURL=0.c8db0dc31d83c0abdcc7.hot-update.js.map