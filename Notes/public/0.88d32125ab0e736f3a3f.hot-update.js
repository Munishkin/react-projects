...
var _NoteGrid = __webpack_require__(80);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    key: 'handleAddNode',
    value: function handleAddNode(note) {
      this.setState({
        notes: [].concat(_toConsumableArray(this.state.notes), [{ id: Date.now(), text: note }])
      });
    }
  }, {
...
//# sourceMappingURL=0.88d32125ab0e736f3a3f.hot-update.js.map